...
CREATE TABLE filtered_orders (order_id INT, amount INT) WITH (storage = 'local', include_header='true', format = 'csv', location = 'samples/result', file_name = 'filtered_orders.csv');
